  ...
  return (
    <Tilt className='xs:w-[250px] w-full'>
      <motion.div
        ...
        className="w-full bg-gradient-to-r from-red-500 to-slate-200 
    border-4 border-transparent 
    bg-clip-padding p-[1px] rounded-[20px] shadow-lg shadow-red-500">
        ...
        <div options={{
          ...
          <h3 className="text-red-400 text-[20px] font-bold text-center">{title}</h3>
        </div>
